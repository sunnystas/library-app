...
let AuthenticationService = class AuthenticationService {
    ...
    login(username, password) {
        return this.http.post(`${_environments_environment__WEBPACK_IMPORTED_MODULE_5__["environment"].apiUrl}/api/auth/login`, { email: username, password: password })
...
module.exports = __webpack_require__(/*! /Users/stanislav/Work/repos/LibraryApp/client/src/main.ts */"./src/main.ts");
